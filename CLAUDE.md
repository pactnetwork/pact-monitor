...
This project is indexed by GitNexus as **pact-network** (876 symbols, 1705 relationships, 41 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
