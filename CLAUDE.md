...
This project is indexed by GitNexus as **pact-network** (828 symbols, 1578 relationships, 33 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
