...
This project is indexed by GitNexus as **pact-network** (830 symbols, 1581 relationships, 33 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
