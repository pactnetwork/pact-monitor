...
This project is indexed by GitNexus as **pact-network** (1841 symbols, 3706 relationships, 133 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
