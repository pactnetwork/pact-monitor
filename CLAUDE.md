...
This project is indexed by GitNexus as **pact-network** (3310 symbols, 7385 relationships, 246 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
