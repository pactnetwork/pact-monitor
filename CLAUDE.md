...
This project is indexed by GitNexus as **pact-network** (858 symbols, 1645 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
