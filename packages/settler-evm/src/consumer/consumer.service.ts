...
/**
 * Pub/Sub consumer — ported verbatim from `@pact-network/settler`. Fully
 * chain-agnostic: it only buffers raw messages and exposes ack/nack. The
 * EVM-specific reinterpretation of the payload happens downstream (batcher
 * guards + submitter mapping).
 */
