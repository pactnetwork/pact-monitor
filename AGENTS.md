...
This project is indexed by GitNexus as **wave-pact-cli** (3305 symbols, 7367 relationships, 246 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
