...
This project is indexed by GitNexus as **pact-network** (1588 symbols, 3300 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
