...
This project is indexed by GitNexus as **pact-network** (1413 symbols, 2854 relationships, 100 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
