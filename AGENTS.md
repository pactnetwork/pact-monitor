...
This project is indexed by GitNexus as **pact-network** (1574 symbols, 3254 relationships, 122 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
