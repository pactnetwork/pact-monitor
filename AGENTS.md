...
This project is indexed by GitNexus as **pact-network** (3538 symbols, 7868 relationships, 262 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
