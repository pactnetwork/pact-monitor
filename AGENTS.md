...
This project is indexed by GitNexus as **pact-network** (3284 symbols, 7320 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
