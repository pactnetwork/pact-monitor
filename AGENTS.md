...
This project is indexed by GitNexus as **pact-network** (3282 symbols, 7296 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
