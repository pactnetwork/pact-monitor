...
This project is indexed by GitNexus as **wave-pact-cli** (3165 symbols, 6985 relationships, 235 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
