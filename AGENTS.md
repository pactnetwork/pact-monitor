...
This project is indexed by GitNexus as **pact-network** (3551 symbols, 7902 relationships, 263 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
