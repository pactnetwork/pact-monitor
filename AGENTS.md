...
This project is indexed by GitNexus as **pact-network** (1322 symbols, 2639 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
